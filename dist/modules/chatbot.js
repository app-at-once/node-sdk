...
class ChatbotModule {
    constructor(httpClient, realtime, clientConfig) {
    ...
    async fetchConfig(projectId) {
        const response = await this.httpClient.get(`/apps/${projectId}/chatbot/config`);
        return response.data;
    }
    renderIframe(options, apiKey, projectId) {
    ...
    renderWidget(options, apiKey, projectId) {
        const container = this.getContainer(options.container);
        const sessionId = options.sessionId || this.generateSessionId();
    ...
    `;
        ...
        const sendMessage = async (message) => {
            ...
            inputField.value = '';
            try {
                const response = await this.httpClient.post(`/apps/${projectId}/chatbot/send`, {
                    message,
                    sessionId,
    ...
    async setupRealtimeConnection(sessionId, messagesEl, options, projectId) {
        await this.realtime.subscribeToChannel(`app:${projectId}:chat:${sessionId}`, (message) => {
