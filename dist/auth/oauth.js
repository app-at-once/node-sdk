...
class OAuthModule {
    ...
    async getConnectedProviders() {
        try {
            const response = await this.httpClient.get('/auth/oauth-connections');
            return response.data;
        }
        catch (error) {
    ...
    async getConnectionStats() {
        try {
            const response = await this.httpClient.get('/auth/oauth-connections/stats');
            return response.data;
        }
        catch (error) {
            throw this.handleOAuthError(error);
    ...
    async getConnectionAuditTrail(limit = 50) {
        try {
            const response = await this.httpClient.get(`/auth/oauth-connections/audit?limit=${limit}`);
            return response.data;
        }
        catch (error) {
            throw this.handleOAuthError(error);
    ...
    async getProviderConnectionDetails(provider) {
        try {
            const response = await this.httpClient.get(`/auth/oauth-connections/${provider}`);
            return response.data;
        }
        catch (error) {
            throw this.handleOAuthError(error);
    ...
    async disconnectProvider(provider) {
        try {
            const response = await this.httpClient.delete(`/auth/oauth-connections/${provider}`);
            return {
                success: true,
    ...
    async refreshProviderToken(provider) {
        try {
            const response = await this.httpClient.post(`/auth/oauth-connections/${provider}/refresh-token`);
            return {
                success: true,
    ...
    async trackProviderUsage(provider, action, metadata) {
        try {
            const response = await this.httpClient.post(`/auth/oauth-connections/${provider}/track-usage`, {
                action,
                metadata,
            });
            return response.data;
    ...
    async getProviderConnectionStatus(provider) {
        try {
            const response = await this.httpClient.get(`/auth/oauth-connections/${provider}/is-connected`);
            return response.data;
        }
        catch (error) {
            return {
    ...
    async bulkDisconnectProviders(providers) {
        try {
            const response = await this.httpClient.post('/auth/oauth-connections/bulk-disconnect', {
                providers,
            });
            return response.data;
        }
