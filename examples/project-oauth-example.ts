...
// Initialize client with simple API key setup
...
async function configureOAuthProviders() {
  try {
    ...
    const providers = await client.projectOAuth.getProjectOAuthProviders('your-project-id');
...
async function manageOAuthProviders(): Promise<void> {
  try {
    ...
    await client.projectOAuth.disableProjectOAuthProvider('your-project-id', 'facebook');
    console.log('Facebook OAuth disabled');

    // Re-enable the provider
    await client.projectOAuth.enableProjectOAuthProvider('your-project-id', 'facebook');
    console.log('Facebook OAuth enabled');

    // Get OAuth analytics
    const analytics = await client.projectOAuth.getProjectOAuthAnalytics('your-project-id');
